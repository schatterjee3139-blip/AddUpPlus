...
export const Card3D = ({ title, text, onViewMore, onSocialClick, customLogo = null }) => {
  return (
    <StyledWrapper>
        ...
        <div className="card">
          ...
          <div className="bottom">
            <div className="social-buttons-container">
              <button className="social-button" onClick={() => onSocialClick?.(0)}>
              ...
              <button className="social-button" onClick={() => onSocialClick?.(1)}>
              ...
              <button className="social-button" onClick={() => onSocialClick?.(2)}>
